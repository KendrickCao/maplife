    ...
    if (response.status == "200") {
        ...
        for (let i = 0;i<data.length;i++) {
            ...
            if (data[i].live===true){
                ...
                nowIcon.options.html = `<div class="nowIcon marker-icon"><img id="custom-div-icon" class="custom-div-now-icon" src="${data[i].user.photosImagePath}"></div>`
                ...
                upcomingIcon.options.html = `<div class="upcomingIcon marker-icon"><img id="custom-div-icon" class="custom-div-upcoming-icon" src="${data[i].user.photosImagePath}"></div>`
